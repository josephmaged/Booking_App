...
import 'package:booking_app_algoriza/core/model/Explore/HotelData.dart';
...
import 'package:booking_app_algoriza/features/booking_successfully/peresentation/pages/booking_successfully.dart';
    ...
    return BlocConsumer<AppCubit, AppState>(
      listener: (context, state) {
        ...
        if (state is CreateBooking) {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const BookingSuccessfully()));
        }
      },
                    ...
                    child: Column(
                      children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                child: TextButton(
                                  onPressed: () {},
                                  child: CustomText(
                                      text: appTranslation(context).show_in_map, style: AppTextStyle.showInMapsStyle),
                                ),
                              ),
                            ],
                          ),
                        ...
                        Row(
                          ...
                          children: [
                            CustomText(text: appTranslation(context).price, style: AppTextStyle.variantStyle),
                            CustomText(text: 'E£${item.price}', style: Theme.of(context).textTheme.bodyText1),
                          ],
                        ),
                        Column(
                          children: [
                            CustomText(text: appTranslation(context).rates, style: AppTextStyle.variantStyle),
                            CustomText(text: '${item.rate} ★', style: Theme.of(context).textTheme.bodyText1),
                          ],
                        ),
                      ],
                    ),
